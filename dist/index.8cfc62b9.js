...
const MetaMaskClientCheck = ()=>{
    ...
    if (!isMetaMaskInstalled()) //If it isn't installed we ask the user to click to install it
    console.log("MetaMask is not installed");
        ...
        connectWallet().then((accounts)=>{
            if (accounts && accounts[0] > 0) {
                ...
                connected(accounts);
            } else console.log("Please connect you wallet");
        });
    }
};
...
},{"@metamask/onboarding":"gSj9U"}],"gSj9U":[function(require,module,exports) {
...
},{}]},["2mNKm","6rimH"], "6rimH", "parcelRequire40eb")
